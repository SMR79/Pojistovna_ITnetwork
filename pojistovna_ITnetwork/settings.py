"""
Django settings for pojistovna_ITnetwork project.
...
ROOT_URLCONF = 'pojistovna_ITnetwork.urls'
...
WSGI_APPLICATION = 'pojistovna_ITnetwork.wsgi.application'
